...
import '/features/auth/data/log_in_view_repo_impl.dart';
import '/features/auth/data/log_in_with_phone_repo_impl.dart';
import '/features/auth/data/sign_up_view_repo_impl.dart';
import '/features/auth/domain/log_in_view_repo.dart';
import '/features/auth/domain/log_in_with_phone_repo.dart';
...
import '/features/auth/presentation/views/managers/log_in_with_phone_manager/login_with_phone_cubit.dart';
import '/features/auth/presentation/views/managers/sign_up_view_manager/sign_up_view_cubit.dart';
import '/features/get_help/data/get_help_repo_impl.dart';
import '/features/get_help/domain/get_help_repo.dart';
import '/features/get_help/presentation/views/manager/get_help_cubit.dart';
import '/features/layout/data/layout_repo_impl.dart';
import '/features/layout/domain/layout_repo.dart';
